...
public class AuthManager implements AuthService {
	...
	public Result registerEmployer(Employer employer, String confirmPassword) {
		...
		if (!checkIfEmailExists(employer.getEmail())) {
			...
			return new ErrorResult(employer.getEmail() + " eklenmiş.");
		}
		...
		String code = emailService.sendCode();
	...
	public Result registerJobseeker(Jobseeker jobseeker, String confirmPassword) {
		...
		if (!checkIfExistsTcNo(jobseeker.getNationalId())) {
			...
			return new ErrorResult(jobseeker.getNationalId() + " eklenmiş.");
		}

		if (!checkIfEmailExists(jobseeker.getEmail())) {

			return new ErrorResult(jobseeker.getEmail() + " eklenmiş.");
		}
